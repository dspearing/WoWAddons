...
L["BANK_AUTO_UPDATE_TEXT"] = "길드 은행 업데이트를 자동 승인"
...
L["CLAMP_TO_SCREEN_TEXT"] = "화면에 창 고정"
L["CLAMP_TO_SCREEN_TITLE"] = "화면에 창 고정"
...
L["SHOW_ICON_TEXT"] = "미니맵 아이콘 보이기"
L["SHOW_ICON_TITLE"] = "미니맵 아이콘 보이기"
...
L["HIDE_PLAYTIME_TEXT"] = "실제 플레이 시간을 감춥니다."
L["HIDE_PLAYTIME_TITLE"] = "실제 플레이 시간 감춤"
...
L["REQUEST_PLAYTIME_DISABLED"] = "플레이 시간은 접속 시 조회되지 않습니다. 마지막으로 알려진 값이 클라이언트 애드온에 전송됩니다."
...
L["SLIDER_EXPIRY_TOOLTIP"] = "우편이 이 날짜 안에 만료되면 경고"
