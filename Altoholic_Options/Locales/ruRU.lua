...
L["BANK_AUTO_UPDATE_TEXT"] = "Разрешать автоматическое обновление банка гильдии"
...
L["CLAMP_TO_SCREEN_TEXT"] = "Фиксировать окно на экране"
L["CLAMP_TO_SCREEN_TITLE"] = "Фиксировать окно на экране"
...
L["SHOW_ICON_TEXT"] = "Показывать иконку на мини-карте"
L["SHOW_ICON_TITLE"] = "Показывать иконку на мини-карте"
...
L["HIDE_PLAYTIME_TEXT"] = "Скрыть время игры"
L["HIDE_PLAYTIME_TITLE"] = "Скрыть время игры"
L["HIDE_PLAYTIME_ENABLED"] = "Время игры равно нулю"
...
L["REQUEST_PLAYTIME_DISABLED"] = "Не передавать время игры при запросах к вам"
...
L["SLIDER_EXPIRY_TOOLTIP"] = "Извещать о истечении срока хранения почты. Указанное значение измеряется в днях."
