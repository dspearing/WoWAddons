...
L["BANK_AUTO_UPDATE_TEXT"] = "自動授權公會金庫更新"
...
L["CLAMP_TO_SCREEN_TEXT"] = "將視窗固定在畫面上"
L["CLAMP_TO_SCREEN_TITLE"] = "將視窗固定在畫面上"
...
L["SHOW_ICON_TEXT"] = "顯示小地圖圖示"
L["SHOW_ICON_TITLE"] = "顯示小地圖圖示"
...
L["Use color-coding for recipes at the AH"] = "拍賣場使用配方的顏色編碼"
L["Use color-coding for recipes at vendors"] = "供應商使用配方的顏色編碼"
...
L["SLIDER_EXPIRY_TOOLTIP"] = "當郵件屆滿少過此值的日數時發出警告"

L["EXPIRY_CHECK_LABEL"] = "郵件屆滿警告"
...
L["EXPIRY_ALL_ACCOUNTS_LABEL"] = "檢查所有已知帳戶的將屆滿郵件"
...
L["EXPIRY_ALL_REALMS_LABEL"] = "檢查所有已知伺服器的將屆滿郵件"
