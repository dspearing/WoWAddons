...
function printUsageMsg()
    print(kAddonName.." "..kAddonVersion.." Slash Commands:")
    print("(Note: Either "..BLUE.."/ct|r".." or "..BLUE.."/"..kAddonName.."|r can be typed for these commands.)")
    ...
    print(GREEN.."PROFILE COMMANDS:")
    print(BLUE.."    /ct delete <profile name>")
    print(BLUE.."    /ct list")
    print(BLUE.."    /ct load <profile name>")
    print(BLUE.."    /ct save <profile name>")
    
    ----print(BLUE.."  /ct screen"..GREEN.." - Print screen info in chat window.")
    ----print(BLUE.."  /ct camera"..GREEN.." - Print camera info in chat window.")
    ----print(BLUE.."  /ct config"..GREEN.." - Print configuration info in chat window.")
    ----print(BLUE.."  /ct model"..GREEN.." - Print model info in chat window.")
    ----print(BLUE.."  /ct cal"..GREEN.." - Calibrate cursor effect to your mouse.")
    ----print(" \n")
end
-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - --
...
Globals.SlashCmdList[kAddonName] = function (params)
    ...
    elseif (params == "reset") then
        ...
        CursorModel_Load()
        CursorTrail_ON()
        print(kAddonName.." reset to original settings.")
    -- - - - - - - - - - - - - - - - - - - - - - - - - - -
    elseif (params == "reload") then
        CursorModel_Load()
        CursorTrail_ON()
        print(kAddonName.." settings reloaded.")
    -- - - - - - - - - - - - - - - - - - - - - - - - - - -
    elseif (params == "combat") then
        ...
        print(kAddonName..GREEN.." 'Show only in combat' |r= "
    ...
    elseif (params == "mouselook") then
        ...
        print(kAddonName..GREEN.." 'Show during Mouse Look' |r= "
    ...
    elseif (params == "fade") then
        ...
        print(kAddonName..GREEN.." 'Fade out when idle' |r= "
    ...
    elseif (params == "off") then
        CursorTrail_OFF()
        CursorModel_Hide()
        print(kAddonName..": "..ORANGE.."OFF|r  (Automatically turns back on at next reload, or by opening the options window.)")
    -- - - - - - - - - - - - - - - - - - - - - - - - - - -
    elseif (HandleToolSwitches(params) ~= true) then
        print(kAddonName..": Invalid slash command ("..params..").")
...
function CursorTrail_ON(bPrintMsg)
    ...
    if bPrintMsg then print(kAddonName..": "..ORANGE.."ON") end
end
