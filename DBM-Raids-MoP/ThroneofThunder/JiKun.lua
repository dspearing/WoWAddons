...
local function GetNestPositions(flockC)
	...
	elseif mod:IsDifficulty("normal25") then
		...
		elseif flockC == 19 then dir, loc = L.UpperAndLower, "27-"..L.ArrowLower.." "..DBM_COMMON_L.UNKNOWN..", 28-"..L.ArrowUpper.." "..L.SouthEast--Lower ? & Upper SE
...
function mod:CHAT_MSG_MONSTER_EMOTE(msg, _, _, _, target)
	if msg:find(L.eggsHatch) and self:AntiSpam(5, 2) then
		...
		elseif self:IsDifficulty("heroic25") then
			...
			elseif flockCount == 16 then specWarnBigBirdSoon:Schedule(20, L.Lower.." ("..DBM_COMMON_L.UNKNOWN..")")
