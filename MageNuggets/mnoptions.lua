...
function loadMageNuggetOptionsVariables_OnLoadEvent()
    ...
    if(MageNuggets_Frames.pyroclasm_point == nil) then
        MageNuggets_Frames.pyroclasm_point = "CENTER";
    end
    if(MageNuggets_Frames.pyroclasm_relativePoint == nil) then
        MageNuggets_Frames.pyroclasm_relativePoint = "CENTER";
    end
    if(MageNuggets_Frames.pyroclasm_xOfs == nil) then
        MageNuggets_Frames.pyroclasm_xOfs = 0;
    end
    if(MageNuggets_Frames.pyroclasm_yOfs == nil) then
        MageNuggets_Frames.pyroclasm_yOfs = 0;
    end
...
function MageNugz_SetFrame_Positions()
    ...
    MageNugPyroclasmProcFrame:SetPoint(MageNuggets_Frames.pyroclasm_point, "UIParent", MageNuggets_Frames.pyroclasm_relativePoint, MageNuggets_Frames.pyroclasm_xOfs, MageNuggets_Frames.pyroclasm_yOfs);
...
function MageNugz_MinimapButton_Move()
	MageNug_MinimapFrame:SetPoint("TOPLEFT","Minimap","TOPLEFT",82-(100*cos(MageNuggets.MinimapPos)),(100*sin(MageNuggets.MinimapPos))-82)
end
