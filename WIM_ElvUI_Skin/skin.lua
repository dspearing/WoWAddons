...
--Default window skin
local WIM_Elvui_Transparent = {
    title = "WIM ElvUI (Transparent)",
    version = "1.0.0",
    author = "fuba",
...
local WIM_Elvui_Solid = {
    title = "WIM ElvUI (Solid)",
    version = "1.0.0",
    author = "fuba",
    website = "https://www.curseforge.com/members/fuba82/projects",
    message_window = {
        texture = "Interface\\AddOns\\WIM_ElvUI_Skin\\images\\default\\message_window_solid",
        min_width = 256,
        min_height = 128,
        backdrop = {
            top_left = {
...
WIM.RegisterSkin(WIM_Elvui_Transparent);
WIM.RegisterSkin(WIM_Elvui_Solid);