...
--	self.DungPopup:SetText(L['static_loadguide']:format(dungeonguide.title_short))
	...
	--	ZGV.NotificationCenter:QueueToast("dungeon",dungeonguide,mapid,nil,nil,popup)
		ZGV.NotificationCenter:HideAllToasts()
...
--	self.MonkPopup:SetText(L['static_loadguide']:format(monkguide.title_short))
	...
	--	ZGV.NotificationCenter:QueueToast("monkdaily",monkguide,nil,nil,nil,popup)
		ZGV.NotificationCenter:HideAllToasts()
...
function GuideFuncs:LearnMountGuideSuggestion(level)
	...
	--	ZGV.NotificationCenter:QueueToast("riding",mountGuide,nil,nil,nil,popup)
		ZGV.NotificationCenter:HideAllToasts()
