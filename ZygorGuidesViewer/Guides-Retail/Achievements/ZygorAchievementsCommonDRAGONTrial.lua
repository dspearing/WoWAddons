...
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Dragon Isles\\Explore the Waking Shores")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Dragon Isles\\Explore the Ohn'ahran Plains")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Dragon Isles\\Explore Thaldraszus")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Dragon Isles\\Explore the Azure Span")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Dragon Isles\\Explore Zaralek Cavern")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Dragon Isles\\Explore the Emerald Dream")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Dragon Isles\\Dragon Isles Explorer")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Dragon Isles\\Dragon Isles Pathfinder")
...
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Dragon Isles\\Explore the Forbidden Reach")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Dragon Isles\\Door Buster")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Dragon Isles\\Treasures of the Forbidden Reach")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Dragon Isles\\Scavenger of the Forbidden Reach")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Dragon Isles\\Hoarder of the Forbidden Reach")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Fruit of the Bloom")
ZGV.DevEnd()
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Quests\\Dream On")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\I Dream of Seeds")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Treasures of the Emerald Dream")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Quests\\Defenders of the Dream")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Adventurer of the Emerald Dream")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Super Duper Bloom")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Exploration\\Emerald Dream Safari")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Quests\\Friends In Feathers")
ZygorGuidesViewer:RegisterGuidePlaceholder("Achievement Guides\\Character Achievements\\Quests\\Of the Tyr's Guard")
