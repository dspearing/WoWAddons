...
ZygorGuidesViewer:RegisterGuide("GOLD\\Gathering\\Rimefin Tuna",{
	...
	label "Start"
		...
		|tip Click the Fishing Bobber when it bounces in the water.
		|tip Keep repeating this process.
		|goldcollect 252 Rimefin Tuna##199345 |goto The Azure Span/0 72.81,45.78 |n
		|goldtracker
		|tip
		_Ready to Sell?_
		Click Here to Sell Your Items on the Auction House |confirm
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Rousing Decay (Fishing)",{
	...
	label "Start"
		...
		//20 Rousing Frostx4 = 80 
		//25 Rousing Decayx4 = 100
		//117 Maybe Meatx4 = 468
	step
	label "AH"
		talk Auctioneer Antiqdormi##197911 |goto Valdrakken/0 42.39,59.99
		|tip List the items you want to sell on the Auction House.
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Rousing Frost (Fishing)",{
	meta={goldtype="route",levelreq={60},itemtype="elemental"},
	items={{190328,1}},
	maps={"The Waking Shores"},
	},[[
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Maybe Meat (Fishing)",{
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Gathering\\Bubble Poppy/Saxifrage",{
	...
	//step
		...
		//path	55.75,59.01	53.58,49.15	50.52,45.37	47.33,41.28	46.32,37.08
		//path	49.26,31.82	54.42,33.68	58.81,32.39	61.34,28.89	64.24,28.61
		//path	66.02,34.45	67.08,39.20	67.59,46.37	69.10,53.88	68.44,60.31
		//path	66.33,64.34	64.33,69.15	60.29,65.29
		//confirm
	step
		talk Auctioneer Antiqdormi##197911 |goto Valdrakken/0 42.39,59.99
		|tip List the items you want to sell on the Auction House.
...
--@@ONLYDEVSTART
ZGV.DevStart()
ZygorGuidesViewer:RegisterGuide("GOLD\\Gathering\\Bubble Poppy/Saxifrage (Ohn'ahran Plains)",{
	meta={goldtype="route",skillreq={dragon_isles_herbalism=1},levelreq={60}},
	items={{191460,176},{191467,40},{191464,40},{197755,32},{190326,32},{190328,40}},
	maps={"Ohn'ahran Plains"},
	},[[
	...
	label "Start"
		...
		path	62.79,47.82	58.99,47.03	55.43,44.81	52.47,43.95	49.24,45.70
		path	47.99,48.67	48.57,51.38	50.65,54.30	51.87,57.27	52.57,61.08
		path	52.53,65.89	54.06,71.03	55.17,76.19	56.71,77.36	61.42,77.18
		path	64.43,78.07	67.10,78.97	71.62,80.21	74.39,79.38	76.72,80.51
		path	79.60,79.29	80.48,77.27	79.02,74.07	76.61,72.96	74.08,73.86
		path	71.90,72.73	71.38,69.14	72.10,63.55	73.72,58.82	76.57,54.73
		path	79.58,49.69	81.52,49.68	83.85,50.99	85.91,50.75	87.90,48.49
		path	86.31,45.78	83.53,45.27	81.52,44.78	79.32,40.62	75.44,36.28
		path	71.86,33.70	70.82,30.69	72.02,27.76	74.46,26.17	74.35,23.86
		path	72.65,23.98	69.19,24.07	67.46,25.39	67.11,28.44	68.66,32.18
		path	69.34,36.12	68.63,41.05	65.60,47.01
		click Bubble Poppy##375241+
		|tip They look like white and green flowers that grow in damp areas.
		click Saxifrage##381207+
		|tip They look like bushy plants that grown on rocks and cliffs.
		...
		_Ready to Sell?_
		Click Here to Sell Your Items on the Auction House |confirm		
		//1/30/2023 1 Rank 2 Bubble Poppyx4 = 4
		//1/30/2023 7 Rank 1 Bubble Poppyx4 =  28
		//1/30/2023 2 Rousing Frostx4 = 8
		//1/30/2023 2 rank 2 Saxifragex4 = 8
		//1/30/2023 5 Lava Beetlex4 = 20
		//1/30/2023 6 Rousing Airx4 = 24
		//1/30/2023 68 Rank 2 Hochenblumex4 = 272	
		...
		//8 Rousing Air = 32
		//10 Rousing Frost = 40
		//2 Rank 1 Bubble Poppy = 8
		//8 Rank 2 Bubble Poppy = 32
	//step
		//was not better.
		//map The Waking Shores
		//path	55.75,59.01	53.58,49.15	50.52,45.37	47.33,41.28	46.32,37.08
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Gathering\\Writhebark",{
	...
	label "Start"
		...
		_Ready to Sell?_
		Click Here to Sell Your Items on the Auction House |confirm
		//83 Rank 2 Hochenblume = 332
		//8 Rousing Decay = 32
		//11 Rank 2 Writhebark = 44
		//10 Rank 1 Writhebark = 40
		//23 Rousing Frost = 92
		//3 lava beetle = 12
		//5 bubble poppy = 20
	step
