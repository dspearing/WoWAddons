...
step
talk Toddy Whiskers##189077
accept The Call of the Isles##70197 |goto 22.72,55.67
|only if Alliance and haveq(70197)
step
talk Toddy Whiskers##189077
...
talk Naleidea Rivergleam##197279
|tip On top of the tower.
accept The Call of the Isles##70198 |goto 55.81,12.66
|only if Horde and haveq(70198)
step
talk Naleidea Rivergleam##197279
|tip On top of the tower.
...
|tip On top of the cliff. Watch out for Grod the Ancient elite.
...
talk Unatos##193015
|tip Inside the building.
accept Well Supplied##70882 |goto 58.16,35.11
...
step
talk Sansok Khan##191283
accept Orientation: Maruukai##72429 |goto Ohn'ahran Plains/0 63.37,41.39
step
talk Quartermaster Huseng##196707
|tip Inside the building.
Meet the Renown Quartermaster |q 72429/2 |goto 60.40,37.72
...
step
click Portal to Valdrakken |goto 67.12,30.92
Return to Valdrakken |goto Valdrakken/0 84.34,53.54 < 1000 |c |noway |q 70182
step
talk Maiden of Inspiration##196475
...
Tell her _"I'm ready to begin."_
Speak with Maiden of Inspiration |q 70376/2 |goto 66.28,55.33
step
...
step
click Portal to Valdrakken |goto 66.25,55.40
Return to Valdrakken |goto Valdrakken/0 84.34,53.54 < 1000 |c |noway |q 70341
step
talk Maiden of Inspiration##196475
turnin Well Earned Victory##70341 |goto 84.33,53.55
step
talk Maiden of Inspiration##196475
...
step
talk Maiden of Inspiration##196475
accept Fifth Challenge of Tyr: Ingenuity##70899 |goto Valdrakken/0 84.35,53.56
step
use Irideus' Power Core##200120
|tip Use it on elite enemies around Tyrhold.
...
accept Innovating the Engine##70900 |goto 84.35,53.56
step
extraaction Insert the Power Core##389124
...
step
label "Gain_Renown"
Raise Your Renown with Dragon Isles Factions |complete completedallq(67084,66128,66444,66547,66402,69888) |or
...
|tip You have completed the "In the Halls of the Titans" chapter. |only if completedq(66547) and not (completedq(69888) and completedq(72822))
|tip At the next weekly reset, the "Unusual Suspects" quest will become available. |only if completedq(66547) and not (completedq(69888) and completedq(72822))
...
'|complete true |next "In_the_Halls_of_Titans_Chapter" |only if factionrenown(2507) >= 24 and not completedq(66547) |or
'|complete true |next "Unusual_Suspects_Quest" |only if completedq(66547) and not (completedq(69888) and completedq(72822)) |or
step
label "Unusual_Suspects_Quest"
talk Toddy Whiskers##187276
|tip Inside the building.
accept Unusual Suspects##69888 |goto The Waking Shores/0 47.22,82.72
step
clicknpc Unusual Researcher##193267
use the Suspicious Persons Scanner##197805
|tip Use it on the Suspicious Researcher.
Scan Suspicious Explorers to Reveal the Spy |q 69888/1 |goto 47.06,80.51
step
talk Toddy Whiskers##187276
|tip Inside the building.
turnin Unusual Suspects##69888 |goto 47.22,82.72
|next "Gain_Renown" |only if not completedallq(67084,66128,66444,66547,66402,69888)
step
...
step
talk Tutaqan##187323
turnin While the Iron Is Hot##66444 |goto 53.66,37.96 |next "Gain_Renown" |only if not completedallq(67084,66128,66444,66547,66402,69888)
...
talk Alexstrasza the Life-Binder##192573
|tip Inside the building.
turnin The Silver Purpose##67084 |goto 60.19,58.64 |next "Gain_Renown" |only if not completedallq(67084,66128,66444,66547,66402,69888)
...
Free Gerithus |q 66397/2 |goto 20.30 49.21
step
...
Deactivate #6# Barrier Moorings |q 66394/1 |goto 19.74,49.91
step
...
Free #4# Emerald Scaleguards or Wardens |q 66397/3 |goto 19.74,49.91
step
...
step
talk Merithra##188848
turnin Like Mother, Like Daughter##66402 |goto 19.77,81.69 |next "Gain_Renown" |only if not completedallq(67084,66128,66444,66547,66402,69888)
...
talk Camilla Highwind##186782
|tip Inside the tent.
turnin Next Steps##66128 |goto 47.21,82.72 |next "Gain_Renown" |only if not completedallq(67084,66128,66444,66547,66402,69888)
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Dragonflight (60-70)\\Tyr's Fall",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Dragonflight (60-70)\\Cause Without a Rebel",{
author="support@zygorguides.com",
description="This guide will help you complete the \"Cause Without a Rebel\" questline.",
...
Click Here to Load the "Thaldraszus (Full Zone)" Leveling Guide |confirm |loadguide "Leveling Guides\\Dragonflight (60-70)\\Full Zones (Story + Side Quests)\\Thaldraszus (Full Zone)" |or
step
talk Captain Drine##189842
|tip At the top of the tower.
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Dragonflight (60-70)\\Some Wicked Things (Warlock)",{
author="support@zygorguides.com",
...
step
Cancel the "Eye of Kilrogg" Buff |nobuff spell:411531
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Dragonflight (60-70)\\Augmentation Questline (Evoker)",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Dragonflight (60-70)\\The Coalition of Flames",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Dragonflight (60-70)\\Reforging the Tyr's Guard",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Dragonflight (60-70)\\Bronze Reconciliation",{
author="support@zygorguides.com",
description="This guide will help you complete the Reforging the Tyr's Guard storyline.",
condition_suggested=function() return level == 70 and not completedq(75638) end,
startlevel=70,
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Dragonflight (60-70)\\Emerald Dream Campaign",{
author="support@zygorguides.com",
description="This guide will help you complete the Emerald Dream campaign questline.",
startlevel=70,
patch='100200',
},[[
leechsteps "Leveling Guides\\Dragonflight (60-70)\\The Coalition of Flames"
step
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Dragonflight (60-70)\\Emerald Dream Campaign + Side Quests",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Dragonflight (60-70)\\Wrathion's Questline",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Dragonflight (60-70)\\Tyr's Return",{
author="support@zygorguides.com",
description="This guide will help you complete the Tyr's Return questline continuing from Tyr's Fall.",
startlevel=70,
patch='100200',
},[[
leechsteps "Leveling Guides\\Dragonflight (60-70)\\Tyr's Fall"
step
talk Valunei##208703
