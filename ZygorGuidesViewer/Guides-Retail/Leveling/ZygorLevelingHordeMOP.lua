...
'|complete completedq(30078) |or |next "Cleaning_House_Done"
...
kill Tak Tak##59958
|tip He walks around this area.
collect 1 Corpse of Tak Tak##80430 |goto 56.68,70.94 |complete itemcount(80430) == 1 or completedq("30599/3")
step
...
|tip He walks around this area.
collect 1 Corpse of Ko Ko##80429 |goto 52.39,71.42 |complete itemcount(80429) == 1 or completedq("30599/2")
step
...
collect 1 Corpse Of Dak Dak##80428 |goto Kun-Lai Summit/12 50.83,42.59 |complete itemcount(80428) == 1 or completedq("30599/1")
step
...
Explore the Vale's Past |complete ZGV.InPhase("Old Vale") |goto Vale of Eternal Blossoms New/0 80.97,29.48 |q 30690
