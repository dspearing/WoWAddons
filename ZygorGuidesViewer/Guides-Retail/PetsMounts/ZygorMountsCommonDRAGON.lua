...
Collect the "Otterworldly Ottuk Carrier" Mount |learnmount Otterworldly Ottuk Carrier##376912
]])
...
Collect the "Hailstorm Armoredon" Mount |learnmount Hailstorm Armoredon##387231
]])
...
Collect the "Raging Magmammoth" Mount |learnmount Raging Magmammoth##374275
]])
...
step
use Shellack##192784
Collect the "Shellack" Mount |learnmount Shellack##374155
]])
...
step
Collect the "Jade, Bright Foreseer" Mount |learnmount Jade, Bright Foreseer##369451
...
step
Collect the "Viridian Phase-Hunter" Mount |learnmount Viridian Phase-Hunter##346136
|tip This mount can be purchased in the Blizzard Store.
|tip Open the Blizzard Store by clicking "Shop" on the character login screen, or click the in-game "Shop" menu, then go to "Mounts."
...
step
Collect the "Lucky Yun" Mount |learnmount Lucky Yun##308087
|tip This mount can be purchased in the Blizzard Store.
|tip Open the Blizzard Store by clicking "Shop" on the character login screen, or click the in-game "Shop" menu, then go to "Mounts."
|tip You may need to click it in your mounts panel to unwrap it after purchasing.
]])
...
Collect the "Nether-Gorged Greatwyrm" Mount |learnmount Nether-Gorged Greatwyrm##367676
]])
...
step
Collect the "Sapphire Skyblazer" Mount |learnmount Sapphire Skyblazer##347812
|tip This mount can be purchased in the Blizzard Store.
|tip Open the Blizzard Store by clicking "Shop" on the character login screen, or click the in-game "Shop" menu, then go to "Mounts."
|tip You may need to click it in your mounts panel to unwrap it after purchasing.
]])
...
step
Collect the "Sunwarmed Furline" Mount |learnmount Sunwarmed Furline##317177
|tip This mount can be purchased in the Blizzard Store.
|tip Open the Blizzard Store by clicking "Shop" on the character login screen, or click the in-game "Shop" menu, then go to "Mounts."
|tip You may need to click it in your mounts panel to unwrap it after purchasing.
]])
...
Collect the "Sylverian Dreamer" Mount |learnmount Sylverian Dreamer##290132
]])
...
step
Collect the "Wen Lo, the River's Edge" Mount |learnmount Wen Lo, the River's Edge##359317
|tip This mount can be purchased in the Blizzard Store.
|tip Open the Blizzard Store by clicking "Shop" on the character login screen, or click the in-game "Shop" menu, then go to "Mounts."
|tip You may need to click it in your mounts panel to unwrap it after purchasing.
|tip You can also obtain this mount by purchasing "Burning Crusade Classic Deluxe Edition".
...
Collect the "Gilded Ravasaur" Mount |learnmount Gilded Ravasaur##255696
]])
...
Collect the "Liberated Slyvern" Mount |learnmount Liberated Slyvern##359622
]])
...
step
Collect the "Zenet Hatchling" Mount |learnmount Zenet Hatchling##385266
...
step
use Otto##198870
Collect the "Otto" Mount |learnmount Otto##376873
]])
...
Click Here to Load the "Full Zones (Story + Side Quests)" Leveling Guide |confirm |loadguide "Leveling Guides\\Dragonflight (60-70)\\Full Zones (Story + Side Quests)\\Intro & The Waking Shores (Full Zone)" |or
step
...
Gain the "Worldbreaker Membership" Buff |havebuff spell:386848 |or
'|learnmount Scrappy Worldsnail##374162 |or
step
...
Collect the "Azure Skitterfly" Mount |learnmount Azure Skitterfly##374034
]])
...
Collect the "Verdant Skitterfly" Mount |learnmount Verdant Skitterfly##374048
]])
...
Collect the "Tamed Skitterfly" Mount |learnmount Tamed Skitterfly##374032
]])
...
Collect the "Loyal Magmammoth" Mount |learnmount Loyal Magmammoth##373859
]])
...
Collect the "Brown Scouting Ottuk" Mount |learnmount Brown Scouting Ottuk##376875
]])
...
Collect the "Brown War Ottuk" Mount |learnmount Brown War Ottuk##376910
]])
...
Collect the "Yellow Scouting Ottuk" Mount |learnmount Yellow Scouting Ottuk##376880
]])
...
Collect the "Yellow War Ottuk" Mount |learnmount Yellow War Ottuk##376913
]])
...
Collect the "Ivory Trader's Ottuk" Mount |learnmount Ivory Trader's Ottuk##376879
]])
...
Collect the "Iskaara Trader's Ottuk" Mount |learnmount Iskaara Trader's Ottuk##376879
]])
...
Click Here to Load the "Time Rifts" Guide |confirm |loadguide "Daily Guides\\Dragonflight (60-70)\\Time Rifts" |or
step
...
Collect the "Perfected Juggernaut" Mount |learnmount Perfected Juggernaut##414328
]])
...
Collect the "Sulfur Hound" Mount |learnmount Sulfur Hound##414327
]])
...
Collect the "Scourgebound Vanquisher" Mount |learnmount Scourgebound Vanquisher##414334
]])
...
Collect the "Felstorm Dragon" Mount |learnmount Felstorm Dragon##414326
]])
...
Collect the "Gold-Toed Albatross" Mount |learnmount Gold-Toed Albatross##414324
]])
...
Collect the "Plainswalker Bearer" Mount |learnmount Plainswalker Bearer##374196
]])
...
Collect the "Stormhide Salamanther" Mount |learnmount Stormhide Salamanther##374098
]])
