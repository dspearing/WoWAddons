...
do
	...
	if Lib then
		...
		function Lib:StepPath()  -- THE WORKHORSE.
			...
			local maxspeed,runspeed,flyspeed,comfortdragonspeed = unpack(speeds)
			if Lib:GetCFG("pathfinding_comfort")>0 and comfortdragonspeed then -- in comfort mode use normal flying mount speed for dragonriding
				flyspeed = comfortdragonspeed
			end
