...
-----------------------------------------------------------------------------------------------------------------
	...
	--	opt_n_popup_wq = "Show world quest popup",
		...
		opt_n_popup_msg_welcome = "Welcome Message",
		opt_n_popup_msg_general = "Latest Updates",
		opt_n_popup_msg_orientation = "Startup Orientation Reminder",
		opt_n_popup_msg_dailyquest = "Daily Quest Reset",
		opt_n_popup_msg_worldquest = "Weekly Quest Reset",
		opt_n_popup_msg_events = "Seasonal Events",
		...
		opt_n_popup_msg_dailyquest_desc = "A message that notifies you when Daily Quests have reset",
		opt_n_popup_msg_worldquest_desc = "A message that notifies you when Weekly Quests have reset",
		opt_n_popup_msg_events_desc = "A message that notifies you when a new seasonal event has started",
