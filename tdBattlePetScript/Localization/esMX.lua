local L = LibStub("AceLocale-3.0"):NewLocale("PetBattleScripts", "esMX") 
...
--[[Translation missing --]]
L["OPTION_SETTINGS_AUTO_SELECT_SCRIPT_BY_ORDER"] = "OPTION_SETTINGS_AUTO_SELECT_SCRIPT_BY_ORDER"
--[[Translation missing --]]
